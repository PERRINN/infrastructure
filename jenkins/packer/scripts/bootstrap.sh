...
wget -P /tmp http://archive.apache.org/dist/maven/binaries/apache-maven-2.2.1-bin.tar.gz
...
sudo tar -xf /tmp/apache-maven-2.2.1-bin.tar.gz -C /opt/apache
sudo ln -s /opt/apache/apache-maven-2.2.1-bin.tar.gz /opt/maven2
...
sudo rm /tmp/apache-maven-2.2.1-bin.tar.gz
